        ...
        <div class="container"> 
            <div class="row">
                <div class="col-12 d-flex flex-row" style="margin-top: 5%;">
                    <h1 id="foodTitle" style="color:white;">Add to Food Inventory</h1> 
                </div>
            </div>
        </div>
        <br>
                    ...
                    <div class="container" style="width: 95%;">
                         ...
                         <div class="row">
                            <div class="col-12 d-flex flex-row">
                                <div class="col-12 d-flex flex-row" style="margin-left: 5%">
                                    ...
                                    <div style="width: 50%">
                                        <textarea type="text" name="item_description" style="width: 100%; height: 100%; resize:none;"></textarea>
                                    </div>
                                 </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12 d-flex flex-row" style="margin-left: 5%">
                                ...
                                <div style="width: 20%">
                                    <input type="number" min="0" step=".01" name="item_price" style="width: 30%;">
                                </div>
                                <div style="width: 20%">
                                    <input type="number" min="0" name="item_quantity" style="width: 35%;">
                                </div>
                            </div>
                        </div>
                    </div>
