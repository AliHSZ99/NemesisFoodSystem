...
<head>
    ...
    <script>
        function printIngredients() {
            var content = document.getElementById("printIngredients").innerHTML;
            var page = window.open('', '');
            page.document.write('<html><head><title>Ingredient</title></head>');
            page.document.write('<body><center><h1>Ingredient<h1>');
...
<body>
    ...
    <div class="blue-box">
        ...
        <div class="container"> 
            <div class="row">
                <form action="/Item/searchIngredients" method="POST">
                    <div class="col-12 d-flex flex-row" style="margin-top: 2%;">
                        <h1 id="foodTitle" style="color:white;">Ingredients</h1>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 d-flex flex-row" style="margin-top: 5%;">
                    <a href="<?=BASE?>Item/addIngredientItem" class="btn btn-success" style="margin-left: 85%; margin-right: 2%; vertical-align: middle;">Add</a>
                    <button class="btn btn-outline-light" onclick="printIngredients()" >Print</button>
                </div>
            </div>
        </div>
        ...
        <div id="printIngredients">
            <div class="container" style="margin-top: 5%;">
                <table class="table table-light table-hover" style="width: 87.7%; margin-left: 6.2%">
                    <tr class="table-secondary" style="table-layout: fixed; width:100%;">
                            ...
                            <?php 
                                foreach ($data as $item) { 
                                        ...
                                        echo "
                                                    ...
                                                    <td>
                                                        <a href='/Item/editItemIngredient/$item->item_id' class='btn btn-primary mt-2'>Edit</a>
                                                        <a href='/Item/deleteItem/$item->item_id' class='btn btn-danger mt-2'>Delete</a> ";
                                        echo "
                                                        <a href='/Item/decrement/$item->item_id' class='btn btn-danger mt-2'>Discard one</a>
