        ...
        <div class="container"> 
            <div class="row">
                <div class="col-12 d-flex flex-row" style="margin-top: 5%; margin-left: 5%;">
                    <h1 id="foodTitle" style="color:white;">Edit Food Inventory Item</h1> 
                </div>
            </div>
        </div>
        <br>
                         ...
                         <div class="row">
                            <div class="col-12 d-flex flex-row">
                                <div class="col-12 d-flex flex-row" style="margin-left: 5%">
                                    ...
                                    <div style="width: 50%">
                                        <textarea required name="item_description" style="width: 100%; height: 100%; resize:none;" id="" cols="30" rows="10"><?php echo $data['item']->item_description; ?></textarea>
                                    </div>
                                 </div>
                            </div>
                        </div>
